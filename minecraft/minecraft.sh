...
APPLINK=https://github.com/DRLEdition19/batocera.drl/raw/main/minecraft/extra/Minecraft
...
mkdir -p ~/pro/.dep 2>/dev/null && cd ~/pro/.dep && wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O ~/pro/.dep/dep.zip https://github.com/DRLEdition19/batocera.drl/raw/main/.dep/dep.zip && yes "y" | unzip -oq ~/pro/.dep/dep.zip && cd ~/
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/icon.png; chmod a+x $dep/* 2>/dev/null; cd ~/
...
curl --progress-bar --remote-name --location "https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/$p1"
curl --progress-bar --remote-name --location "https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/$p2"
curl --progress-bar --remote-name --location "https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/$p3"
# libselinux.so.1
d2=libselinux.so.1
wget -q -O /userdata/system/pro/minecraft/extra/$d2 https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/$d2
ln -s /userdata/system/pro/minecraft/extra/$d2 /lib/$d2 2>/dev/null
# tar
d3=tar
wget -q -O /userdata/system/pro/minecraft/extra/$d3 https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/$d3
chmod a+x $d3 
#
d4=libsecret-1.so.0
wget -q -O /userdata/system/pro/minecraft/extra/$d4 https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/$d4
# --- join liblauncher
...
wget -q -O "/userdata/roms/ports/Minecraft.sh.keys" "https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/minecraft/extra/Darknior-Minecraft.sh.keys" 
