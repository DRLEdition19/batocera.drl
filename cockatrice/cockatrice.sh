...
APPLINK=https://github.com/Cockatrice/Cockatrice/archive/refs/tags/2023-09-14-Release-2.9.0.tar.gz
...
##curl --progress-bar --remote-name --location "https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/$c1"
##curl --progress-bar --remote-name --location "https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/$c2"
# --- join
##cat $temp/cockatrice.tar.bz2.parta* >$temp/cockatrice.tar.gz
###curl --progress-bar --remote-name --location "https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/cockatrice.zip"
...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/icon.png
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/.batocera https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/batocera.sh
...
wget --tries=10 -q -O "/userdata/roms/ports/$appname.sh.keys" "https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/$appname/extra/$appname.sh.keys"
# --------------------------------------------------------------------
