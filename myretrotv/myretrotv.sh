...
#url=https://github.com/DRLEdition19/batocera.drl/raw/main/.dep
...
#wget -q -O $pro/$appname/extra/icon.png https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/icon.png; chmod a+x $dep/tput; cd ~/
# --------------------------------------------------------------------
# // end of dependencies 
#
...
# 
wget -q -O $icon https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/icon.png
wget -q -O /userdata/system/pro/$appname/extra/chrome.png https://github.com/DRLEdition19/batocera.drl/raw/main/myretrotv/extra/chrome.png
wget -q -O /userdata/system/pro/$appname/extra/myretrotvs.png https://github.com/DRLEdition19/batocera.drl/raw/main/myretrotv/extra/myretrotvs.png
wget -q -O /userdata/system/pro/$appname/extra/my00stv.png https://github.com/DRLEdition19/batocera.drl/raw/main/myretrotv/extra/my00stv.png
wget -q -O /userdata/system/pro/$appname/extra/my90stv.png https://github.com/DRLEdition19/batocera.drl/raw/main/myretrotv/extra/my90stv.png
wget -q -O /userdata/system/pro/$appname/extra/my80stv.png https://github.com/DRLEdition19/batocera.drl/raw/main/myretrotv/extra/my80stv.png
wget -q -O /userdata/system/pro/$appname/extra/my70stv.png https://github.com/DRLEdition19/batocera.drl/raw/main/myretrotv/extra/my70stv.png
wget -q -O /userdata/system/pro/$appname/extra/my60stv.png https://github.com/DRLEdition19/batocera.drl/raw/main/myretrotv/extra/my60stv.png
wget -q -O /userdata/system/pro/$appname/extra/myretrotv.sh.keys https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/myretrotv/extra/myretrotv.sh.keys
# //
...
wget -q -O "/userdata/system/pro/chrome/myretrotv.sh.keys" https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/myretrotv/extra/myretrotv.sh.keys
#cp "/userdata/system/pro/chrome/myretrotv.sh.keys" "/userdata/roms/ports/MyRetroTVs.sh.keys"
cp "/userdata/system/pro/chrome/myretrotv.sh.keys" "/userdata/roms/ports/My00sTV.sh.keys"
cp "/userdata/system/pro/chrome/myretrotv.sh.keys" "/userdata/roms/ports/My90sTV.sh.keys"
cp "/userdata/system/pro/chrome/myretrotv.sh.keys" "/userdata/roms/ports/My80sTV.sh.keys"
