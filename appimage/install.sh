...
declare -a urls=(
    "https://github.com/DRLEdition19/batocera.drl/raw/main/appimage/aip.sh"
    "https://github.com/DRLEdition19/batocera.drl/raw/main/appimage/aiparser.sh"
    "https://github.com/DRLEdition19/batocera.drl/raw/main/appimage/caip.sh"
)
...
wget -O "/userdata/roms/ports/AppImage Parser.sh" "https://github.com/DRLEdition19/batocera.drl/raw/main/appimage/AppImage%20Parser.sh"
