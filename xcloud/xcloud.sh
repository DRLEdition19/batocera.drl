...
if [[ ! -s "$keys" ]]; then
  wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O "$keys" "https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/xcloud/extra/xcloud.sh.keys"
