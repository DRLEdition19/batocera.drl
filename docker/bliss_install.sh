...
if ! command -v docker &> /dev/null; then
    ...
    curl -L https://github.com/DRLEdition19/batocera.drl/raw/main/docker/install.sh | bash
...
mkdir -p ~/pro/bliss
curl -Ls https://github.com/DRLEdition19/batocera.drl/raw/main/docker/bliss.sh -o ~/pro/bliss/bliss.sh
chmod +x ~/pro/bliss/bliss.sh
sleep 5

echo "Installing Shortcut to ports..."
mkdir -p /userdata/roms/ports
curl -Ls https://github.com/DRLEdition19/batocera.drl/raw/main/docker/Bliss-OS.sh -o /userdata/roms/ports/Bliss-OS.sh
...
sleep 5
curl -Ls https://github.com/DRLEdition19/batocera.drl/raw/main/docker/bliss_cli.sh | bash
