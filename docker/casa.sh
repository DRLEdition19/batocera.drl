...
sleep 3
curl -L https://github.com/DRLEdition19/batocera.drl/raw/refs/heads/main/.dep/.scripts/aria2c.sh | bash
sleep 2
clear
...
ZIP_PART_1="https://github.com/DRLEdition19/Containers-bat/releases/download/containers/batocera-casaos.tar.zip.001"
ZIP_PART_2="https://github.com/DRLEdition19/Containers-bat/releases/download/containers/batocera-casaos.tar.zip.002"
ZIP_PART_3="https://github.com/DRLEdition19/Containers-bat/releases/download/containers/batocera-casaos.tar.zip.003"
ZIP_PART_4="https://github.com/DRLEdition19/Containers-bat/releases/download/containers/batocera-casaos.tar.zip.004"
...
./aria2c -x 5 "https://github.com/DRLEdition19/Containers-bat/releases/download/containers/batocera-casaos" -o "casaos/batocera-casaos"
