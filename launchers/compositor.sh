...
case $response in
   0)
      ...
      wget -O ~/batocera-compositor/batocera-compositor https://github.com/DRLEdition19/batocera.drl/raw/refs/heads/main/launchers/compositor/batocera-compositor
