...
wget https://github.com/DRLEdition19/batocera.drl/raw/main/EKA2L1/shortcut/EKA2L1.sh -O /userdata/roms/ports/EKA2L1.sh > /dev/null 2>&1 && chmod +x /userdata/roms/ports/EKA2L1.sh > /dev/null 2>&1
echo "DONE"
sleep 3
