...
cd $thisdir
wget -q --tries=10 -O $thisdir/utils_dwarfs.tar.gz https://github.com/DRLEdition19/batocera.drl/raw/main/steam/build/utils_dwarfs.tar.gz
...
"curl -Ls https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/steam/build/patch.sh | bash && exit"
# ------------------------------------------------------------------------------------------
