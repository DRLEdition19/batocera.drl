...
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$script_dir/utils/libunionfs.so" "https://github.com/DRLEdition19/batocera.drl/blob/main/steam/build/unionfs/libunionfs.so"
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$script_dir/utils/unionfsctl" "https://github.com/DRLEdition19/batocera.drl/blob/main/steam/build/unionfs/unionfsctl"
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$script_dir/utils/unionfs3" "https://github.com/DRLEdition19/batocera.drl/blob/main/steam/build/unionfs/unionfs3"
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$script_dir/utils/unionfs" "https://github.com/DRLEdition19/batocera.drl/blob/main/steam/build/unionfs/unionfs"
...
"curl -Ls https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/steam/build/libc-dthash-patch.sh | bash && exit"
# ------------------------------------------------------------------------------------------
