...
curl -Ls https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/steam/build/compress.sh -o compress.sh
curl -Ls https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/steam/build/conty-start.sh -o conty-start.sh
curl -Ls https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/steam/build/create.sh -o create.sh
...
# Update shortcuts
wget -q --tries=30 --no-check-certificate --no-cache --no-cookies --tries=50 -O /tmp/update_shortcuts.sh https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/steam/update_shortcuts.sh
