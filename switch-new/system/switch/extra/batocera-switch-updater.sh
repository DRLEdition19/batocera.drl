...
version=$(curl -s https://api.github.com/repos/GreemDev/Ryujinx-Canary/releases/latest | grep -oP '(?<="tag_name": ")[^"]*')
wget -q --show-progress --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/ryujinx-${version}-linux_x64.tar.gz" "https://github.com/GreemDev/Ryujinx-Canary/releases/download/$version/ryujinx-canary-${version}-linux_x64.tar.gz"
...
url_es_features_switch=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/configs/emulationstation/es_features_switch.cfg
url_es_systems_switch=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/configs/emulationstation/es_systems_switch.cfg
...
url_updater=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra/batocera-switch-updater.sh
url_portsupdater=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/roms/ports/Switch%20Updater.sh
url_portsupdaterkeys=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/roms/ports/Switch%20Updater.sh.keys   
