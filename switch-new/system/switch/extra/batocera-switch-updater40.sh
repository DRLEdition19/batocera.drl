         ...
         ####################################################################
            u=/userdata/system/switch/extra/batocera-switch-desktopupdater.sh
               rm "$u" 2>/dev/null
                  ...
                  echo "  wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O /tmp/.batocera-switch-updater40.sh https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra/batocera-switch-updater40.sh" >> "$u"
                  ##echo "  curl -sSf https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra/batocera-switch-updater40.sh -o /tmp/.batocera-switch-updater40.sh " >> "$u"
...
EMULATORS="$(echo $EMULATORS | sed 's/ /-/g')"
   ...
   if [[ ! -f $cfg ]]; then 
      link_defaultconfig=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra/batocera-switch-config.txt
...
# \\ 
link_tar=https://github.com/DRLEdition19/batocera.drl/blob/main/switch-new/raw/main/system/switch/extra/batocera-switch-tar
link_libselinux=https://github.com/DRLEdition19/batocera.drl/blob/main/switch-new/raw/main/system/switch/extra/batocera-switch-libselinux.so.1
...
# fix broken libstdc++.so.6 for v37 
		   if [[ "$(uname -a | awk '{print $3}')" > "6.2" ]]; then 
			  link_libstdc=https://github.com/DRLEdition19/batocera.drl/blob/main/switch-new/raw/main/system/switch/extra/batocera-switch-libstdc++.so.6
...
# /userdata/system/switch/extra/ryujinx/ will keep all ryujinx related dependencies
		  ...
		  wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$extra/$emu/xdg-mime" "https://github.com/DRLEdition19/batocera.drl/blob/main/switch-new/raw/main/system/switch/extra/xdg-mime"
		  ###curl -sSf "https://github.com/DRLEdition19/batocera.drl/blob/main/switch-new/raw/main/system/switch/extra/xdg-mime" -o "$extra/$emu/xdg-mime"
		  ...
		  wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/extra/extralibr.zip" "https://github.com/DRLEdition19/batocera.drl/blob/main/switch-new/raw/main/system/switch/extra/extralibr.zip"
...
# ------------------------------------------------------------------- 
   extraurl="https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra"
# ------------------------------------------------------------------- 
...
#   wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/configgen/mapping.csv" "https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/configgen/mapping.csv"
...
# -------------------------------------------------------------------
# prepare patcher 
#url_patcher="https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra/batocera-switch-patcher.sh"
...
url_switchkeys=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/configs/evmapy/switch.keys
...
# url_switchlauncher=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/configgen/switchlauncher.py
# url_GeneratorImporter=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/configgen/GeneratorImporter.py
# url_ryujinxMainlineGenerator=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/configgen/generators/ryujinx/ryujinxMainlineGenerator.py
# url_yuzuMainlineGenerator=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/configgen/generators/yuzu/yuzuMainlineGenerator.py
#url_sshupdater=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra/batocera-switch-sshupdater.sh
url_updater=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra/batocera-switch-updater40.sh
url_portsupdater=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/roms/ports/Switch%20Updater40.sh
url_portsupdaterkeys=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/roms/ports/Switch%20Updater40.sh.keys   
...
url=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/configgen40
...
url=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/configgen40/generators
mkdir -p $path 2>/dev/null
...
url=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/configgen40/generators/yuzu
mkdir -p $path 2>/dev/null
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$path/__init__.py" "$url/__init__.py"
##curl -sSf "$url/__init__.py" -o "$path/__init__.py"
...
url=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/configgen40/generators/ryujinx
mkdir -p $path 2>/dev/null
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$path/__init__.py" "$url/__init__.py"
##curl -sSf "$url/__init__.py" -o "$path/__init__.py"
...
# additional pass for folks who have issues connecting to github
   function get() {
      file="$1"
      path=/userdata/system/switch/configgen/sdl2
      url=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/configgen/sdl2
         mkdir -p $path 2>/dev/null
            if [[ ! -e "$path/$file" ]]; then
               cd $path
...
sdlurl=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra/batocera-switch-libSDL2.so
   if [[ ! -e "$sdl" ]]; then 
...
urldir="https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra"
...
url=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra/translations
mkdir -p $path 2>/dev/null
...
# GET TRANSLATOR
translator=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra/batocera-switch-translator.sh
...
file=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra/batocera-switch-ryujinx-fixes.sh
...
# include display output: 
   ...
   mkdir /userdata/system/switch 2>/dev/null; mkdir /userdata/system/switch/extra 2>/dev/null
      if [[ ( -e "$tput" && "$(wc -c "$tput" | awk '{print $1}')" < "444" ) || ( ! -e "$tput" ) ]]; then
         rm "$tput" 2>/dev/null
         wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O /userdata/system/switch/extra/batocera-switch-tput https://github.com/DRLEdition19/batocera.drl/blob/main/switch-new/raw/main/system/switch/extra/batocera-switch-tput
         ##curl -sSf "https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra/batocera-switch-tput" -o "/userdata/system/switch/extra/batocera-switch-tput"
      fi
      if [[ ( -e "$libtinfo" && "$(wc -c "$libtinfo" | awk '{print $1}')" < "444" ) || ( ! -e "$libtinfo" ) ]]; then
         rm "$libtinfo" 2>/dev/null
         wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O /userdata/system/switch/extra/batocera-switch-libtinfo.so.6 https://github.com/DRLEdition19/batocera.drl/blob/main/switch-new/raw/main/system/switch/extra/batocera-switch-libtinfo.so.6
         ##curl -sSf "https://raw.githubusercontent.com/DRLEdition19/batocera.drl/refs/heads/main/switch-new/system/switch/extra/batocera-switch-libtinfo.so.6" -o "/userdata/system/switch/extra/batocera-switch-libtinfo.so.6"
      fi
