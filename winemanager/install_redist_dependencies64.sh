...
wget -P "$WINE_EXE_DIR" "https://batocera.org/users/liberodark/wine/vcredist_x64_2015_2019.exe"

# Baixar Visual C++ Redistributable 2019
echo "Baixando Visual C++ Redistributable 2019..."
wget -P "$WINE_EXE_DIR" "https://batocera.org/users/liberodark/wine/vcredist_x64_2019.exe"

# Baixar Visual C++ Redistributable 2017
echo "Baixando Visual C++ Redistributable 2017..."
wget -P "$WINE_EXE_DIR" "https://batocera.org/users/liberodark/wine/vcredist_x64_2017.exe"

# Baixar Visual C++ Redistributable 2015
echo "Baixando Visual C++ Redistributable 2015..."
wget -P "$WINE_EXE_DIR" "https://batocera.org/users/liberodark/wine/vcredist_x64_2015.exe"

# Baixar Visual C++ Redistributable 2013
echo "Baixando Visual C++ Redistributable 2013..."
wget -P "$WINE_EXE_DIR" "https://batocera.org/users/liberodark/wine/vcredist_x64_2013.exe"

# Baixar Visual C++ Redistributable 2012
echo "Baixando Visual C++ Redistributable 2012..."
wget -P "$WINE_EXE_DIR" "https://batocera.org/users/liberodark/wine/vcredist_x64_2012.exe"

# Baixar Visual C++ Redistributable 2010
echo "Baixando Visual C++ Redistributable 2010..."
wget -P "$WINE_EXE_DIR" "https://batocera.org/users/liberodark/wine/vcredist_x64_2010.exe"

# Baixar Visual C++ Redistributable 2008
echo "Baixando Visual C++ Redistributable 2008..."
wget -P "$WINE_EXE_DIR" "https://batocera.org/users/liberodark/wine/vcredist_x64_2008.exe"

# Baixar Visual C++ Redistributable 2005
echo "Baixando Visual C++ Redistributable 2005..."
wget -P "$WINE_EXE_DIR" "https://batocera.org/users/liberodark/wine/vcredist_x64_2005.exe"
