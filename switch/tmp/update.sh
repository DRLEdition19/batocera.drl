...
#link_ryujinx=https://github.com/DRLEdition19/batocera.drl/raw/main/switch/extra/ryujinx-1.1.382-linux_x64.tar.gz
...
cd $temp/$emu
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$extra/$emu/xdg-mime" "https://github.com/DRLEdition19/batocera.drl/raw/main/switch/extra/xdg-mime"
###curl -sSf "https://github.com/DRLEdition19/batocera.drl/raw/main/switch/extra/xdg-mime" -o "$extra/$emu/xdg-mime"
...
#link_ryujinxldn=https://github.com/DRLEdition19/batocera.drl/raw/main/switch/extra/ryujinx-1.1.0-ldn3.0.1-linux_x64.tar.gz
link_ryujinxldn=https://github.com/DRLEdition19/batocera.drl/raw/main/switch/extra/ryujinx-1.1.0-ldn3.1.3-linux_x64.tar.gz
## -------------------------------------------------------------------
# RYUJINXAVALONIA:
link_ryujinxavalonia=https://github.com/Ryujinx/release-channel-master/releases/download/$release_ryujinx/test-ava-ryujinx-$release_ryujinx-linux_x64.tar.gz
#
