...
wget -q -O /userdata/system/pro/rpcs3/extra/tput https://github.com/DRLEdition19/batocera.drl/raw/main/rpcs3/extra/tput
chmod +x $pro/rpcs3/extra/tput
wget -q -O /userdata/system/pro/rpcs3/extra/libtinfo.so.6 https://github.com/DRLEdition19/batocera.drl/raw/main/rpcs3/extra/libtinfo.so.6
...
sleep 1
echo
urlextra=https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/rpcs3/extra
# delete old ports
...
#wget -q -O "/userdata/roms/ports/RPCS3 Updater.sh" https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/rpcs3/rpcs3.sh
