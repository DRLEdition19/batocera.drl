...
APPLINK=https://github.com/DRLEdition19/batocera.drl/raw/refs/heads/main/qdirstat/extra/qdirstat.AppImage
...
wget -q -O $pad2key https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/qdirstat/extra/QDirStat.sh.keys
# -- done. 
sleep 1
echo -e "${G}> ${W}DONE"
echo
