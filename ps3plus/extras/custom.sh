...
echo -e "${A}██${X}  ${H}applying batocera compatibility fixes..."
	cd ~/pro/ps3plus/rpcs3 
		wget -q --no-check-certificate --no-cache --no-cookies -O ~/pro/ps3plus/rpcs3/ai.AppImage "https://github.com/DRLEdition19/batocera.drl/raw/main/ps3plus/extras/ai.AppImage"
		wget -q --no-check-certificate --no-cache --no-cookies -O ~/pro/ps3plus/rpcs3/file "https://github.com/DRLEdition19/batocera.drl/raw/main/ps3plus/extras/file"
