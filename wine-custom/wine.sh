...
case $CHOICE in
    1)
        ...
        curl -L https://github.com/DRLEdition19/batocera.drl/raw/main/wine-custom/vanilla.sh | bash
        ;;
    2)
        echo "You chose Wine-tkg staging."
        curl -L https://github.com/DRLEdition19/batocera.drl/raw/main/wine-custom/tkg.sh | bash
        ;;

    3)
        echo "You chose Wine-GE Custom."
        curl -L  https://github.com/DRLEdition19/batocera.drl/raw/main/wine-custom/wine-ge.sh | bash
        ;;
    4)
        echo "You chose GE-Proton."
        curl -L  https://github.com/DRLEdition19/batocera.drl/raw/main/wine-custom/ge-proton.sh | bash
        ;;
    5)
        echo "You chose Steamy-AIO."
        curl -L  https://github.com/DRLEdition19/batocera.drl/raw/main/wine-custom/steamy.sh | bash
        ;;    
     *)
