...
animate_title() {
    local text="BATOCERA APP INSTALLER | UPDATED BY DRLEDITION"
    local delay=0.03
    local length=${#text}
...
apps=(
    ...
    ["ARCH-CONTAINER"]="curl -L https://github.com/DRLEdition19/batocera.drl/raw/refs/heads/main/steam/install_new.sh | bash"
    ["ARCH-Config"]="curl -L https://github.com/DRLEdition19/batocera.drl/raw/refs/heads/main/steam/steam.sh | bash"
    ...
    ["EKA2L1"]="curl -L https://github.com/DRLEdition19/batocera.drl/raw/refs/heads/main/EKA2L1/EKA2L1.sh | bash"
    ...
    ["STEAM/CONTAINER"]="curl -L https://github.com/DRLEdition19/batocera.drl/raw/refs/heads/main/steam/steam.sh | bash"
...
#    ["SWITCH-EMULATION-OLD-TEST"]="curl -L https://github.com/DRLEdition19/batocera.drl/raw/refs/heads/main/switch/switch.sh | bash"
    ...
    ["WINE-DEPENDENCIES-x86"]="curl -L https://github.com/DRLEdition19/batocera.drl/raw/refs/heads/main/winemanager/install_redist_dependencies32.sh | bash"
    ["WINE-DEPENDENCIES-x64"]="curl -L https://github.com/DRLEdition19/batocera.drl/raw/refs/heads/main/winemanager/install_redist_dependencies64.sh | bash"
