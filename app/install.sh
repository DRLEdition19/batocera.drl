...
curl -L https://github.com/DRLEdition19/batocera.drl/raw/main/app/pro.sh -o /userdata/system/pro/pro.sh

# Download BatoceraPRO.sh to /userdata/roms/ports
curl -L https://github.com/DRLEdition19/batocera.drl/raw/main/app/BatoceraPRO.sh -o /userdata/roms/ports/BatoceraPRO.sh

# Download BatoceraPRO.sh.keys to /userdata/roms/ports
wget  https://github.com/DRLEdition19/batocera.drl/raw/main/app/bkeys.txt -P /userdata/roms/ports/
