...
sleep 1
echo -e "${T}https://github.com/DRLEdition19/batocera.drl/raw/main/heroic/extra/Proton-GE-Proton7-42.tar.xz" | sed 's,https://,> ,g' | sed 's,http://,> ,g' 2>/dev/null
cd $temp
p1=https://github.com/DRLEdition19/batocera.drl/raw/main/heroic/extra/Proton-GE-Proton7-42.tar.xz.partaa
p2=https://github.com/DRLEdition19/batocera.drl/raw/main/heroic/extra/Proton-GE-Proton7-42.tar.xz.partab
p3=https://github.com/DRLEdition19/batocera.drl/raw/main/heroic/extra/Proton-GE-Proton7-42.tar.xz.partac
...
# --------------------------------------------------------------------
# get heroic-sync.sh 
wget -q -O /userdata/system/pro/$appname/extra/heroic-sync.sh https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/heroic/extra/heroic-sync.sh
...
wget -q -O $pro/$appname/es_systems_heroic.cfg https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/es_systems_heroic.cfg
...
wget -q -O "/userdata/roms/heroic/Fall Guys.txt" "https://github.com/DRLEdition19/batocera.drl/raw/main/$appname/extra/FallGuys.txt"
