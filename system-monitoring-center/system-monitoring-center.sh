...
APPLINK=https://github.com/DRLEdition19/batocera.drl/raw/refs/heads/main/system-monitoring-center/extra/system-monitoring-center.tar.gz
...
wget -q -O "/userdata/roms/ports/system-monitoring-center.sh.keys" "https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/system-monitoring-center/extra/system-monitoring-center.sh.keys"
# --------------------------------------------------------------------
