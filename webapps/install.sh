...
BASE_URL="https://github.com/DRLEdition19/batocera.drl/raw/main/webapps"

# Create the ~/webapps directory
mkdir -p ~/webapps

# Download the specified scripts into ~/webapps
curl -L https://github.com/DRLEdition19/batocera.drl/raw/main/webapps/native.sh -o ~/webapps/native.sh
curl -L https://github.com/DRLEdition19/batocera.drl/raw/main/webapps/nlaunch.sh -o ~/webapps/nlaunch.sh
curl -L https://github.com/DRLEdition19/batocera.drl/raw/main/webapps/chrome.sh -o ~/webapps/chrome.sh
curl -L https://github.com/DRLEdition19/batocera.drl/raw/main/webapps/webapps.sh -o ~/webapps/webapps.sh
...
curl -L https://github.com/DRLEdition19/batocera.drl/raw/main/webapps/Add-WebApp.sh -o /userdata/roms/webapps/+ADD-WEB-APPS.sh
...
curl -L https://github.com/DRLEdition19/batocera.drl/raw/main/webapps/es_systems_webapps.cfg -o ~/configs/emulationstation/es_systems_webapps.cfg
