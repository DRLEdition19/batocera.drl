...
echo -e "\n  preparing dark theme for f1/gtk/pcmanfm..."
	...
	# get files 
	url=https://github.com/DRLEdition19/batocera.drl/raw/main/dark/Adwaita-dark.zip
	cd /userdata/system/pro/dark
		wget -q "https://github.com/DRLEdition19/batocera.drl/raw/main/dark/Adwaita-dark.zip"
			unzip -oq ./Adwaita-dark.zip 
				cp -r ./Adwaita-dark /usr/share/themes/
		wget -q -O $f/dark.sh "https://raw.githubusercontent.com/DRLEdition19/batocera.drl/main/dark/dark.sh"
