...
wget https://github.com/DRLEdition19/batocera.drl/raw/main/bedrock/shortcut/Minecraft-Bedrock.sh -O /userdata/roms/ports/Minecraft-Bedrock.sh > /dev/null 2>&1 && chmod +x /userdata/roms/ports/Minecraft-Bedrock.sh > /dev/null 2>&1
echo "DONE"
sleep 3
